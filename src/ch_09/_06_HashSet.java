...
public class _06_HashSet {
  ...
  public static void main(String[] args) {
    ...
    intSet.add(13);
    intSet.add(2);
    System.out.println("HashSet 는 순서 보장 X");
    for (int i : intSet) {
      System.out.println(i);
    }
    // linked Hash Set 은 순서 보장 됨.
    HashSet<Integer> intlinkedSet = new LinkedHashSet<>();
    intlinkedSet.add(1);
    intlinkedSet.add(13);
    intlinkedSet.add(2);
    System.out.println("LinkedHashSet 는 순서 보장 O");
    for (int i : intlinkedSet) {
      System.out.println(i);
    }
  }
